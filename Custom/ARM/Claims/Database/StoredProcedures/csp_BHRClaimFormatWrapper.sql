...
if (@ServicesBeforeCutover = 'Y' AND @ServicesAfterCutover = 'Y' AND @ServicesAfterMCOCutover = 'Y' AND @MCOApplies = 'Y')
	OR (@ServicesBeforeCutover = 'Y' AND @ServicesAfterCutover = 'Y' )
	OR (@ServicesBeforeCutover = 'Y'  AND @ServicesAfterMCOCutover = 'Y'  AND @MCOApplies = 'Y')
	OR (@ServicesAfterCutover = 'Y' AND @ServicesAfterMCOCutover = 'Y'  AND @MCOApplies = 'Y')
...
select
	@TargetClaimFormatId = case when @ServicesBeforeCutover = 'Y' then cpcf.ClaimFormatPriorToBHRedesign 
								WHEN @ServicesAfterCutover = 'Y' THEN cpcf.ClaimFormatAfterBHRedesign 
								WHEN @ServicesAfterMCOCutover = 'Y'  AND cpcf.ClaimFormatAfterMCO IS NOT NULL THEN cpcf.ClaimFormatAfterMCO 
								WHEN @ServicesAfterMCOCutover = 'Y'  AND cpcf.ClaimFormatAfterMCO IS NULL THEN cpcf.ClaimFormatAfterBHRedesign END,
	@TargetStoredProcedure = case when @ServicesBeforeCutover = 'Y' then cfbefore.StoredProcedure
									WHEN @ServicesAfterCutover = 'Y' THEN cfafter.StoredProcedure 
								 WHEN @ServicesAfterMCOCutover = 'Y' then cfafterMCO.StoredProcedure END
