/****** Object:  StoredProcedure [dbo].[csp_RDLClientPrescriptionMain]    Script Date: 01/05/2016 12:50:03 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[csp_RDLClientPrescriptionMain]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[csp_RDLClientPrescriptionMain]
GO
 ...
 --get Client Info    
            INSERT  INTO #ScriptHeader    
                    ...
                    SELECT  ( SELECT    OrganizationName    
                            ...
                            c.DOB AS ClientDOB ,    
                            ISNULL(l.Address, '') + CHAR(10) AS LocationAddress,    
