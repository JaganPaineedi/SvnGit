...
IF EXISTS ( SELECT	*
			FROM	sys.objects
			WHERE	object_id = OBJECT_ID(N'[dbo].[csp_SCGetAllergies]')
					AND type IN ( N'P', N'PC' ) ) 
	DROP PROCEDURE [dbo].csp_SCGetAllergies
 --18,1,null
GO

/****** Object:  StoredProcedure [dbo].[csp_SCGetAllergies]    Script Date: 07/01/2013 19:25:54 ******/
SET ANSI_NULLS ON
GO

SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[csp_SCGetAllergies]
	(
	  @ClientId INT             
	)
AS 
