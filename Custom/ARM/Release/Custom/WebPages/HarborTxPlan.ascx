<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HarborTxPlan.ascx.cs"
    Inherits=" SHS.SmartCare.ActivityPages_Client_Detail_HarborTreatmentPlan_HarborTxPlan" %>
...
<script type="text/javascript" language="javascript" src="<%=RelativePath%>Custom/Scripts/HarborTreatmentPlan.js"></script>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td class="padding_Label" align="center">
                                                            <textarea name="TextArea_CustomTreatmentPlans_CurrentDiagnosis" id="TextArea_CustomTreatmentPlans_CurrentDiagnosis"
                                                                rows="5" cols="158" class="form_textareaWithoutWidth" disabled="disabled" datatype="String" spellcheck="True"></textarea>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
