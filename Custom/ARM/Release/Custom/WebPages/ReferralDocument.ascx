                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" id="TableChildControl_CustomDocumentReferralServices">
                                                        <tr>
                                                            ...
                                                            <td style="width: 10%;height:100%" valign="top"  >
                                                                <span id="ButtonInsert" name="ButtonInsert" runat="server" type="button" onclick="InsertGridData('TableChildControl_CustomDocumentReferralServices', 'InsertGrid','CustomGrid','ButtonInsert');"
