        ...
        <td>
            <dxtc:ASPxPageControl ID="PsychiatricEvaluationsTabPage" ClientInstanceName="PsychiatricEvaluationsTabPage" runat="server" ActiveTabIndex="0"
                ...
                <TabPages>
                    ...
                    <dxtc:TabPage Text="Diagnosis" Name="/Custom/WebPages/PsychiatricDiagnosis.ascx">
                        <ContentCollection>
...
<input id="HiddenFieldPageTables" name="HiddenFieldPageTables" type="hidden" value="CustomDocumentPsychiatricEvaluations,DiagnosesIII,DiagnosesIV,DiagnosesV,DiagnosesIANDIIMaxOrder,CustomDocumentMentalStatuses" />
