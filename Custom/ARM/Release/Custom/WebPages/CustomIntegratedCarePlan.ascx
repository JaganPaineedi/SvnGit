                                    ...
                                    <tr>
                                        <td style="text-align: right; padding: 5px;">
                                            <input type="button" id="TableChildControl_CustomDocumentHealthHomeCarePlanDiagnoses_ButtonInsert"
                                                ...
                                                value="Insert" class="parentchildbutton" /><input type="button" id="Button2" onclick="CustomIntegratedCarePlan.Clear_CustomDocumentHealthHomeCarePlanDiagnoses_Data();$('#TextBox_CustomDocumentHealthHomeCarePlanDiagnoses_ReportedDiagnosis').focus();"
                                        ...
                                        <td>
                                            <div id="InsertGrid_CustomDocumentHealthHomeCarePlanDiagnoses" style="overflow-x: hidden;
                                                ...
                                                <uc1:CustomGrid ID="CustomGrid_CustomDocumentHealthHomeCarePlanDiagnoses" runat="server"
                                                    ...
                                                    ColumnHeader="Reported Diagnosis:Treatment Provider" ColumnWidth="250:250" DivGridName="InsertGrid_CustomDocumentHealthHomeCarePlanDiagnoses"
                                    ...
                                    <tr>
                                        <td style="text-align: right; padding: 5px;">
                                            <input type="button" id="TableChildControl_CustomDocumentHealthHomeCarePlanOutcomes_ButtonInsert"
                                                ...
                                                value="Insert" class="parentchildbutton" /><input type="button" id="Button1" onclick="CustomIntegratedCarePlan.Clear_CustomDocumentHealthHomeCarePlanOutcomes_Data();$('#TextArea_CustomDocumentHealthHomeCarePlanOutcomes_OutcomeDescription').fosus();"
                                                    name="ButtonClear" value="Clear" class="parentchildbutton" />
                                        </td>
                                    </tr>
                                    <!-- Custom Grid -->
                                    <tr>
                                        <td>
                                            <div id="InsertGrid_CustomDocumentHealthHomeCarePlanOutcomes" style="overflow-x: hidden;
                                                overflow-y: auto; height: 100px; width: 800px;">
                                                <uc1:CustomGrid ID="CustomGrid_CustomDocumentHealthHomeCarePlanOutcomes" runat="server"
                                                    ...
                                                    ColumnHeader="Expected Outcomes:Outcome Criteria:Target Date" ColumnWidth="300:300:60"
                                        ...
                                        <tr>
                                            <td>
                                                <div id="InsertGrid_CustomDocumentHealthHomeCarePlanBHGoals" style="overflow-x: hidden;
                                                    overflow-y: auto; height: 100px; width: 800px;">
                                                    <uc1:CustomGrid ID="CustomGrid_CustomDocumentHealthHomeCarePlanBHGoals" runat="server"
                                                        ...
                                                        ColumnHeader="Goal:Services:Target Date:" ColumnWidth="300:300:80" DivGridName="InsertGrid_CustomDocumentHealthHomeCarePlanBHGoals"
                                    ...
                                    <tr>
                                        <td style="text-align: right; padding: 5px;">
                                            <input type="button" id="TableChildControl_CustomDocumentHealthHomeCarePlanPESNeeds_ButtonInsert"
                                                ...
                                                value="Insert" class="parentchildbutton" /><input type="button" id="Button3" onclick="CustomIntegratedCarePlan.Clear_CustomDocumentHealthHomeCarePlanPESNeeds_Data();$('[Id$=DropDownList_CustomDocumentHealthHomeCarePlanPESNeeds_PsychosocialSupportNeedType]').focus();"
                                                    name="ButtonClear" value="Clear" class="parentchildbutton" />
                                        </td>
                                    </tr>
                                    <!-- Custom Grid -->
                                        ...
                                        <td>
                                            <div id="InsertGrid_CustomDocumentHealthHomeCarePlanPESNeeds" style="overflow-x: hidden;
                                                ...
                                                <uc1:CustomGrid ID="CustomGrid_CustomDocumentHealthHomeCarePlanPESNeeds" runat="server"
                                                    ...
                                                    ColumnHeader="Need:Plan" ColumnWidth="100:400" DivGridName="InsertGrid_CustomDocumentHealthHomeCarePlanPESNeeds"
                                            ...
                                            <tr>
                                                <td style="text-align: right; padding: 5px;">
                                                    ...
                                                    <input type="button" id="TableChildControl_CustomDocumentHealthHomeCarePlanLongTermCareOutcomes_ButtonInsert"
                                                        ...
                                                        value="Insert" class="parentchildbutton" /><input type="button" id="Button4" onclick="CustomIntegratedCarePlan.Clear_CustomDocumentHealthHomeCarePlanLongTermCareOutcomes_Data();$('#TextArea_CustomDocumentHealthHomeCarePlanLongTermCareOutcomes_OutcomeDescription').focus();"
                                                            name="ButtonClear" value="Clear" class="parentchildbutton" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <div id="InsertGrid_CustomDocumentHealthHomeCarePlanLongTermCareOutcomes" style="overflow-x: hidden;
                                                        overflow-y: auto; height: 100px; width: 800px;">
                                                        <uc1:CustomGrid ID="CustomGrid_CustomDocumentHealthHomeCarePlanLongTermCareOutcomes"
                                                            ...
                                                            ColumnFormat=":date" ColumnHeader="Expected Outcomes:Target Date" ColumnWidth="400:80"
