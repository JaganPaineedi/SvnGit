...
<table class="DocumentScreen" border="0" cellspacing="0" cellpadding="0" style="padding-right: 25px">
    <tr>
        <td style="padding-left: 10px; padding-right: 5px">
            ...
            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_LastVisitDate"  datatype="Date"
                name="TextBox_CustomDocumentHealthHomeServiceNotes_LastVisitDate" class="form_textbox element"
                style="width: 75px;" />
                ...
                <tr>
                    <td class="content_tab_bg">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="padding-left: 10px; padding-right: 5px">
                                    <textarea id="TextArea_CustomDocumentHealthHomeServiceNotes_CurrentMentalHealthDiagnoses"
                                        name="TextArea_CustomDocumentHealthHomeServiceNotes_CurrentMentalHealthDiagnoses"
                                            ...
                                            <td colspan="5">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr id="rowldl">
                                                        ...
                                                        <td style="width: 18%">
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_LDLDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_LDLDate"  datatype="Date"
                                                    ...
                                                    <tr id="rowalc">
                                                        ...
                                                        <td style="width: 18%">
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_ALCDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_ALCDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 18%">
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDVSDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDVSDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                        ...
                                                        <td style="width: 18%">
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDTDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDTDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDPDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDPDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDRDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDRDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDBPDiastolicDate"  datatype="Date"
                                                                name="TextBox_CustomDocumentHealthHomeServiceNotes_HDBPDiastolicDate" class="form_textbox element"
                                                                style="width: 75px;" />
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDBPSystolicDate"  datatype="Date"
                                                                name="TextBox_CustomDocumentHealthHomeServiceNotes_HDBPSystolicDate" class="form_textbox element"
                                                                style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDHtDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDHtDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDWtDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDWtDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDWCDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDWCDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                        ...
                                                        <td>
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDBMIDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDBMIDate"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="5">
                                                            <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_HDSaO2Date" name="TextBox_CustomDocumentHealthHomeServiceNotes_HDSaO2Date"  datatype="Date"
                                                                class="form_textbox element" style="width: 75px;" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <input class="cursor_default" type="checkbox" style="vertical-align: bottom" id="Checkbox_CustomDocumentHealthHomeServiceNotes_MedAllergyListReviewed"
                                                                name="Checkbox_CustomDocumentHealthHomeServiceNotes_MedAllergyListReviewed"
                                                                onclick="" />
                                        ...
                                        <tr id="RescueEncounter">
                                            <td style="width: 40%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RescueMentalHealthEncounterDate"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RescueMentalHealthEncounterDate"  datatype="Date"
                                                    class="form_textbox element" style="width: 75px;" />
                                            ...
                                            <td style="width: 60%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RescueMentalHealthFollowUpDate"  datatype="Date"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RescueMentalHealthFollowUpDate"
                                        ...
                                        <tr id="psychiatric1">
                                            <td style="width: 40%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalDischargeDate"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalDischargeDate"  datatype="Date"
                                                    class="form_textbox element" style="width: 75px;" />
                                            ...
                                            <td style="width: 60%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalFollowUpDate"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalFollowUpDate"  datatype="Date"
                                                    onchange="CheckDateRange('TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalDischargeDate','TextBox_CustomDocumentHealthHomeServiceNotes_RecentPsychHospitalFollowUpDate','Psychiatric');"
                                                    class="form_textbox element" style="width: 75px;" />
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr id="EmergencyTr">
                                            <td style="width: 40%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentEmergencyDeptEncounterDate" name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentEmergencyDeptEncounterDate"
                                            ...
                                            <td style="width: 60%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentEmergencyDeptFollowUpDate"  datatype="Date"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentEmergencyDeptFollowUpDate"
                                        ...
                                        <tr id="Physical1">
                                            <td style="width: 40%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalDischargeDate"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalDischargeDate"  datatype="Date"
                                                    class="form_textbox element" style="width: 75px;" />
                                            ...
                                            <td style="width: 60%">
                                                ...
                                                <input type="text" id="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalFollowUpDate"
                                                    name="TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalFollowUpDate"  datatype="Date"
                                                    onchange="CheckDateRange('TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalDischargeDate','TextBox_CustomDocumentHealthHomeServiceNotes_RecentPhysicalHospitalFollowUpDate','Physical');"
                                                    class="form_textbox element" style="width: 75px;" />
                                        ...
                                        <tr>
                                            <td style="width: 100%" colspan="2">
                                                ...
                                                <input class="cursor_default" type="radio" style="vertical-align: bottom" id="RadioButton_CustomDocumentHealthHomeServiceNotes_PlannedTransitionsLongTermCareAOD_N"
                                                    name="RadioButton_CustomDocumentHealthHomeServiceNotes_PlannedTransitionsLongTermCareAOD" onclick="EnableOrDisableControls()"
                                                    value="N" />
