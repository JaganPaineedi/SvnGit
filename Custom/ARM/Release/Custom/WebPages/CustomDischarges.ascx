...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="content_tab_left" align="left" width="15%">
                   Scores <%--<input type="text" id="CustomDocumentDischargeGoals_${SourceObjectiveID}_ObjectiveNumber" style="border:none; background: transparent; width:20%;" bindautosaveevents="False" />--%>
                </td>
                <td width="17">
                    <img style="vertical-align: top" src="<%=RelativePath%>App_Themes/Includes/Images/content_tab_sep.gif"
                        width="17" height="26" alt="" />
...
<tr>
   <td width="100%">
      <table width="100%">
        <tr>
            <td class="LPadd2" style="width: 70px;  font-weight:bold;">
                <span class="form_label">DAST Score</span>
            </td>

            <td class="LPadd2">
                <input class="form_textbox"  type="text" 
                style="width: 100px"  id="TextBox_CustomDocumentDischarges_DASTScore"
                name="TextBox_CustomDocumentDischarges_DASTScore" maxlength="4" DataType="Numeric"/>
            </td>
            
             <td class="LPadd2" style="width: 70px; font-weight:bold;">
                <span class="form_label">MAST Score</span>
            </td>

            <td class="LPadd2">
                <input class="form_textbox"  type="text" 
                style="width: 100px"  id="TextBox_CustomDocumentDischarges_MASTScore"
                name="TextBox_CustomDocumentDischarges_MASTScore" maxlength="4" DataType="Numeric"/>
            </td>
        </tr>
    </table>
   </td>
...
<tr>
   <td width="100%">
      <table width="100%">
        <tr>
          <td style="width:70px; font-weight:bold; padding-left: 7px";>
        <span id="Span21">Initial Level of Care :</span>
 </td>

 <td class="form_dropdownTD" align="left" style="width: 214px; padding-left:7px">
   <DropDownGlobalCodes:DropDownGlobalCodes ID="DropDownGlobalCodes_CustomDocumentDischarges_InitialLevelofCare" 
  GlobalCodeId="" Width="210px" runat="server"  onchange="" Category="XLEVELOFCARE"
      Height="16px">
  </DropDownGlobalCodes:DropDownGlobalCodes>
 </td>
            
            <td style="width:80px;font-weight:bold ">
        <span id="Span22">Discharge Level of Care :</span>
 </td>

 <td class="form_dropdownTD" align="left" style="width: 214px; padding-left:7px">
   <DropDownGlobalCodes:DropDownGlobalCodes ID="DropDownGlobalCodes_CustomDocumentDischarges_DischargeLevelofCare" 
  GlobalCodeId="" Width="210px" runat="server" onchange="" Category="XLEVELOFCARE"  
      Height="16px">
 </DropDownGlobalCodes:DropDownGlobalCodes>
 </td>
        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td class="style1" style="height:25px;font-weight:bold; padding-left: 7px;">
                            <span id="Span7" class"form_label">Medication currently prescribed to the client by A Renewed Mind
                                prescribers:</span>
                        </td>
                    </tr>
                    <tr>
