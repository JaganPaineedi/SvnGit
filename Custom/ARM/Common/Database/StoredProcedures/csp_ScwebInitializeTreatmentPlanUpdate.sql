/****** Object:  StoredProcedure [dbo].[csp_ScwebInitializeTreatmentPlanUpdate]    Script Date: 08/20/2015 12:28:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[csp_ScwebInitializeTreatmentPlanUpdate]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[csp_ScwebInitializeTreatmentPlanUpdate]
GO
...
GO
 ...
 CREATE procedure [dbo].[csp_ScwebInitializeTreatmentPlanUpdate] --3,550,N''  
...
BEGIN  
/*********************************************************************/  
/* Stored Procedure: [csp_ScwebInitializeTreatmentPlanUpdate]     */  
...
-- 6/5/2012   -  Maninder  - Commented statements for TPQuick  
 ...
 -- Feb 26, 2018    Vijeta        Converted ssp_ScwebInitializeTreatmentPlanUpdate to csp_ScwebInitializeTreatmentPlanUpdate for task:	A Renewed Mind - Support #814
 -- MAy 04, 2018    Vijeta        Added Distinct keyword foe the table CustomTPNeeds as it is parent table for CustomTPGoalNeeds, task:	A Renewed Mind - Support #814
/*********************************************************************/  
BEGIN TRY  
...
BEGIN CATCH  
 ...
 SET @Error= Convert(varchar,ERROR_NUMBER()) + '*****' + Convert(varchar(4000),ERROR_MESSAGE())  
    + '*****' + isnull(Convert(varchar,ERROR_PROCEDURE()),'csp_ScwebInitializeTreatmentPlanUpdate')  
