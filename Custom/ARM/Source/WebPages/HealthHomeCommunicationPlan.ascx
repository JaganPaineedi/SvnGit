            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td class="content_tab_left" align="left" nowrap='nowrap'>
                        <span id="Span15">Harbor Health Home Services Team</span>
                    </td>
                    <td width="17">
                ...
                <tr>
                    <td >
                        <span id="ExternalProvidersNote" class="form_label_text">This section is for other healthcare
                            ...
                            <br />
                            Harbor may contact and coordinate care with these providers, unless the client specifically
                ...
                <tr>
                    <td >
                        <table style="width: 100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td colspan="4">
                                    <span id="ManagedMedicaid" class="form_label">( This entity will provide Harbor with
                                        information regarding your treatment outside Harbor and Harbor will report information
                            ...
                            <tr>
                                ...
                                <td>
                                    <label id="CustomDocumentHealthHomeCommPlans_ClientGuardianParticipatedInPlan_Y"
                                        ...
                                        provided the information listed above in order for Harbor to collaborate/communicate
                            ...
                            <tr>
                                ...
                                <td>
                                    <label id="CustomDocumentHealthHomeCommPlans_ClientGuardianParticipatedInPlan_N"
                                        ...
                                        Harbor to collaborate/communicate with these partners. The client/guardian indicates
