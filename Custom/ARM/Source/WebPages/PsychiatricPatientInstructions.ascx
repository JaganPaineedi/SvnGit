<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PsychiatricPatientInstructions.ascx.cs"
    Inherits="ActivityPages_Harbor_Client_Detail_Documents_PsychiatricEvaluation_PsychiatricPatientInstructions" %>
    ...
    <tr>
        <td class="content_tab_bg" style="padding-left: 8px">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <textarea rows="6" cols="160" id="TextArea_CustomDocumentPsychiatricEvaluations_OtherInstructions"
