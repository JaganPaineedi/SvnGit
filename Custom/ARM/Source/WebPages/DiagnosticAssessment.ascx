        ...
        <td valign="top" style="width: 100%; padding-top: 0px;">
            <telerik:RadTabStrip ID="RadTabStrip1" Skin="Vista"  Width="840px"
                ...
                <Tabs>
                  ...
                  <telerik:RadTab Text="Diagnosis" UcName="DiagnosticAssessmentDx" Path="/ICD10Diagnosis/Documents/ICDTenDiagnosis.ascx"
                        runat="server" >
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
    ...
    <tr>
        <td>
            ...
            <input type="hidden" id="HiddenField_DiagnosesIAndII_DiagnosisId" name="HiddenField_DiagnosesIAndII_DiagnosisId"
                ...
                value="-1" parentchildcontrols="True" />
               <input id="HiddenFieldPageTables" name="HiddenFieldPageTables" type="hidden" value="CustomDocumentDiagnosticAssessments,CustomDocumentAssessmentNeeds,CustomDocumentMentalStatuses,CustomTreatmentPlans,DocumentInitializationLog,CustomDocumentCrisisInterventionNotes,DocumentDiagnosis,DocumentDiagnosisFactors" />
