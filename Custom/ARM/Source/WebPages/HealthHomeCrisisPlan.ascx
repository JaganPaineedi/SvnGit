                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <label for="Checkbox_CustomDocumentHealthHomeCrisisPlans_ClientGuardianParticipatedInPlan">
                                                    Client/Guardian participated in this plan and agrees to use the information in this
                                                    plan to update his/her Crisis Plan.</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="height2">
...
<script id="TestDiagnosisListTemplate" type="text/x-jQuery-tmpl">
    <tr>
        <td align='left' style="width: 124px">${CodeName}</td>
        <td align='left' style="width: 112px">${ICD9Code}</td>
        <td align='left' style="width: 124px">${ICD10Code}</td>
        <td align='left' style="width: 118px">${DSMVCode}</td>
        <td class="ellipsis" onmouseover='javascript:ShowCustomToolTip(this)' align='left' style="width: 200px">${ICDDescription}</td>
    </tr>
