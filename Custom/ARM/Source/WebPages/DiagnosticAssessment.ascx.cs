...
public partial class ActivityPages_Harbor_Client_Detail_Documents_DiagnosticAssessment_DiagnosticAssessment : SHS.BaseLayer.ActivityPages.DocumentDataActivityMultiTabPage
{
    ...
    {
        get { return new string[] { "CustomDocumentDiagnosticAssessments,CustomDocumentAssessmentNeeds,CustomDocumentAssessmentReferrals,CustomDocumentAssessmentTransferServices,CustomDocumentMentalStatuses,CustomTreatmentPlans,CustomTPGoals,CustomDocumentCrisisInterventionNotes,DocumentDiagnosis,DocumentDiagnosisFactors" }; }
    }
