                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" id="TableChildControl_CustomDocumentTransferServices">
                                                        <tr>
                                                            ...
                                                            <td style="width: 10%;height:100%" valign="top"  >
                                                                <span id="ButtonInsert" name="ButtonInsert" runat="server" type="button" onclick="InsertGridData('TableChildControl_CustomDocumentTransferServices', 'InsertGrid','CustomGrid','ButtonInsert');" ClientIDMode="Static"
