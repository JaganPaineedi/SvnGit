                ...
                <TabPages>
                   ...
                   <%-- <dxtc:TabPage Text="Diagnosis" Name="/Custom/WebPages/MedNoteDiagnosis.ascx">
                    ...
                    <dxtc:TabPage Text="Diagnosis" Name="/ICD10Diagnosis/Documents/ICDTenDiagnosis.ascx">
                        <ContentCollection>
                            <dxw:ContentControl ID="ContentControDiagnosis" runat="server">
                            </dxw:ContentControl>
                        </ContentCollection>
                    </dxtc:TabPage>
...
<input id="HiddenFieldPageTables" name="HiddenFieldPageTables" type="hidden" value="CustomDocumentMedicationReviewNotes,CustomDocumentMentalStatuses,DocumentDiagnosis,DocumentDiagnosisFactors" />
