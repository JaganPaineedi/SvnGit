DROP PROCEDURE [dbo].[csp_ValidateCustomDocumentDiagnosticAssessmentsInitialAdult]
GO
...
CREATE PROCEDURE [dbo].[csp_ValidateCustomDocumentDiagnosticAssessmentsInitialAdult] 
(
...
SELECT 'CustomDocumentDiagnosticAssessments'
	,'DeletedBy'
	,'Psychosocial: Client strengths entry is required'
	,2
	,7
FROM #CustomDocumentDiagnosticAssessments
...
SELECT 'CustomDocumentDiagnosticAssessments'
	,'DeletedBy'
	,'Substance use: client reports substance use yes/no required'
	,2
	,19
FROM #CustomDocumentDiagnosticAssessments
...
SELECT 'CustomDocumentDiagnosticAssessments'
	,'DeletedBy'
	,'Substance use: Explanation of substance use is required'
	,2
	,20
FROM #CustomDocumentDiagnosticAssessments
WHERE [ClientReportAlcoholTobaccoDrugUse] = 'Y'
...
SELECT 'CustomDocumentDiagnosticAssessments'
	,'DeletedBy'
	,'Recommended Svcs: Assessed need for transfer required'
	,2
	,55
FROM #CustomDocumentDiagnosticAssessments
WHERE [PrimaryClinicianTransfer] = 'Y'
