-- *********************************************************************************/ 
-- Author: Vichee		
-- Create date: 13/Apr/2015 
-- Description:	DocumentCodes,Screens,Banners entry for "Crisis Service Note". 
--*********************************************************************************/ 
...
SET @DocumentCodeId =60006
SET @TableList = 'CustomAcuteServicesPrescreens,CustomMedicationHistory,CustomSUSubstances,DocumentDiagnosisCodes,DocumentDiagnosis,DocumentDiagnosisFactors'
SET @ViewStoredProcedure = 'csp_RDLGetDataCustomAcuteServicesPrescreens' 
SET @ViewDocumentURL = 'RDLPreScreen'
SET @ViewDocumentRDL = 'RDLPreScreen'
SET @DocumentName = 'Crisis Service Note' 
SET @InitializationProcess = ''
SET @ValidationStoredProcedure='csp_ValidateCustomDocumentCrisisServiceNote'
SET @DocumentType = 10 
SET @Active = 'Y' 
SET @ServiceNote = 'Y' 
...
SET @GetDataSp = 'csp_SCWebGetCustomAcuteServicesPrescreens'
...
SET @ScreenId =  10038
SET @ScreenName = 'Crisis Service Note' 
SET @ScreenType = 5763 
SET @ScreenURL = '/Custom/CrisisServiceNote/WebPages/PreScreenEvent.ascx' 
SET @InitializationStoredProcedure = 'csp_PAInitVenturePreScreen'
SET @ValidationStoredProcedureUpdate = NULL
SET @ValidationStoredProcedureComplete= 'csp_ValidateCustomDocumentCrisisServiceNote'
SET @WarningStoredProcedureComplete= NULL 
SET @PostUpdateStoredProcedure= 'csp_SCPostSignatureUpdateCrisisServiceNote'
