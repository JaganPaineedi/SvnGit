/* 
InsertScript_REPORTS_GOBHIAssessmentFollowup
New Direction - Support Go Live Task #582
Create Reports table entry
mlightner - 04/24/2017
*/

declare	@ReportName varchar(250) = 'GOBHI Percentage of Clients with Assessment and 1 Additional Service';
	-- Also for Folder Name
declare	@IsFolder char(1) = 'N';
declare	@RDLName varchar(100) = 'RDLGOBHIAssessmentFollowup';
...
if not exists ( select	*
   ...
   begin
		 insert	into dbo.Reports
				...
				, ReportServerPath )
		 values	( @ReportName
				, 'Report to list the Clients with an Assessment within the date range and indicate if they have completed at least 1 Additional Service (Followup) within 30 days of the Assessment'
				, @IsFolder
				, @GOBHIIdentity
				, case @AssocWith
