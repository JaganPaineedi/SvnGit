...
declare	@CategoryCode varchar(100)			= 'GOBHIUrgentPrograms'		-- [New Category Code]
declare @CategoryDescription varchar(max)	= 'Oregon State Reporting for GOBHI: Programs for related Urgent care'	-- [Category Description]
...
from dbo.Programs p
where isnull(p.RecordDeleted, 'N') = 'N' and p.ProgramCode like ( '%urgent%' )
