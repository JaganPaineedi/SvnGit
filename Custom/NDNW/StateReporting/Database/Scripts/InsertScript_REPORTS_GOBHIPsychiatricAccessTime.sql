/* 
InsertScript_REPORTS_GOBHIPsychiatricAccessTime
New Direction - Support Go Live Task #553
Create Reports table entry
mlightner - 04/20/2017
*/

declare	@ReportName varchar(250) = 'GOBHI Psychiatric Access Time';
	-- Also for Folder Name
declare	@IsFolder char(1) = 'N';
declare	@RDLName varchar(100) = 'RDLGOBHIPsychiatricAccessTime';
