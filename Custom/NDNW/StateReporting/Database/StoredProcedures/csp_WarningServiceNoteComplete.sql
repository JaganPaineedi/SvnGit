 if exists ( select	*
			 from	sys.objects
			 where	object_id = object_id(N'[dbo].[csp_WarningServiceNoteComplete]')
					and type in ( N'P', N'PC' ) )
	drop procedure [dbo].[csp_WarningServiceNoteComplete];
 go
 ...
 create procedure [dbo].[csp_WarningServiceNoteComplete]
		@DocumentVersionId as int
 as /*********************************************************************                                                                                          
 	File Procedure:		dbo.csp_WarningServiceNoteComplete.sql
		...
		begin                                                              
			  ...
			  begin catch                  
					...
					set @Error = convert(varchar, error_number()) + '*****' 
							   ...
							   + isnull(convert(varchar, error_procedure()), '[csp_WarningServiceNoteComplete]') + '*****' 
