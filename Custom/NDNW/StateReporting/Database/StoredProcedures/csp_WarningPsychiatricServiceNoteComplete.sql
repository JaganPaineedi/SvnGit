 if exists ( select	*
			 from	sys.objects
			 where	object_id = object_id(N'[dbo].[csp_WarningPsychiatricServiceNoteComplete]')
					and type in ( N'P', N'PC' ) )
	drop procedure [dbo].[csp_WarningPsychiatricServiceNoteComplete];
 go
 ...
 create procedure [dbo].[csp_WarningPsychiatricServiceNoteComplete]
		@DocumentVersionId as int
 as /*********************************************************************                                                                                          
 	File Procedure:		dbo.csp_WarningPsychiatricServiceNoteComplete.sql
		...
		begin                                                              
			  ...
			  begin catch                  
					...
					set @Error = convert(varchar, error_number()) + '*****' 
							   ...
							   + isnull(convert(varchar, error_procedure()), '[csp_WarningPsychiatricServiceNoteComplete]') + '*****' 
