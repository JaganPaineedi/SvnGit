 if exists ( select	*
			 from	sys.objects
			 where	object_id = object_id(N'[dbo].[csp_WarningPsychiatricEvaluationComplete]')
					and type in ( N'P', N'PC' ) )
	drop procedure [dbo].[csp_WarningPsychiatricEvaluationComplete];
 go
 ...
 create procedure [dbo].[csp_WarningPsychiatricEvaluationComplete]
		@DocumentVersionId as int
 as /*********************************************************************                                                                                          
 	File Procedure:		dbo.csp_WarningPsychiatricEvaluationComplete.sql
		...
		begin                                                              
			  ...
			  begin catch                  
					...
					set @Error = convert(varchar, error_number()) + '*****' 
							   ...
							   + isnull(convert(varchar, error_procedure()), '[csp_WarningPsychiatricEvaluationComplete]') + '*****' 
