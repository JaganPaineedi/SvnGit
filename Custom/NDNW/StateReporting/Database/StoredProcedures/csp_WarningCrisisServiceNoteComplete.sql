 if exists ( select	*
			 from	sys.objects
			 where	object_id = object_id(N'[dbo].[csp_WarningCrisisServiceNoteComplete]')
					and type in ( N'P', N'PC' ) )
	drop procedure [dbo].[csp_WarningCrisisServiceNoteComplete];
 go
 ...
 create procedure [dbo].[csp_WarningCrisisServiceNoteComplete]
		@DocumentVersionId as int
 as /*********************************************************************                                                                                          
 	File Procedure:		dbo.csp_WarningCrisisServiceNoteComplete.sql
		...
		begin                                                              
			  ...
			  begin catch                  
					...
					set @Error = convert(varchar, error_number()) + '*****' 
							   ...
							   + isnull(convert(varchar, error_procedure()), '[csp_WarningCrisisServiceNoteComplete]') + '*****' 
