If Exists (Select * From   sys.Objects 
           Where  Object_Id = Object_Id(N'dbo.csp_SCGetClientInformationReleasesReleaseToName') 
                  And Type In ( N'P', N'PC' )) 
 Drop Procedure dbo.csp_SCGetClientInformationReleasesReleaseToName
Go
...
/* 12/22/2015 Govind		  Modified closing parentheses for not exists statement NDNW Sup Go Live#188 */       
/***************************************************************************/                
  BEGIN    
  BEGIN TRY      
...
where
  Not  exists (Select CDRI.ClientInformationReleaseId 
             ...
             and ISNULL( ds.[RecordDeleted],'N')='N')--Modified by Govind, NDNW SupGoLive#188
