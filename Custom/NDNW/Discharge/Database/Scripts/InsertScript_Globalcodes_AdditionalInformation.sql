IF NOT EXISTS (SELECT * FROM GlobalCodeCategories WHERE CategoryName = 'XCDLEGAL' AND Category = 'XCDLEGAL')
BEGIN
	...
	VALUES ('XCDLEGAL','XCDLEGAL','Y','Y','Y','Y','Valley - Customizations #929','N','N','Y')
END
ELSE
BEGIN
	UPDATE GlobalCodeCategories SET Category = 'XCDLEGAL' ,CategoryName = 'XCDLEGAL',Active = 'Y',AllowAddDelete = 'Y',AllowCodeNameEdit = 'Y',AllowSortOrderEdit = 'Y',[Description] = 'Valley - Customizations #929',UserDefinedCategory = 'N',HasSubcodes = 'N',UsedInPracticeManagement = 'Y'	WHERE CategoryName = 'XCDLEGAL' AND Category = 'XCDLEGAL'
END

DELETE FROM GlobalCodes WHERE Category = 'XCDLEGAL' AND Active = 'Y' and GlobalCodeId > 10000

IF NOT EXISTS (
		SELECT 1 FROM dbo.GlobalCodes WHERE Category = 'XCDLEGAL' AND CodeName='Voluntary'
		)
BEGIN
...
END
IF NOT EXISTS (
		SELECT 1 FROM dbo.GlobalCodes WHERE Category = 'XCDLEGAL' AND CodeName='Involuntary ? Civil'
		)
BEGIN
	INSERT INTO globalcodes (
		Category
...
END
IF NOT EXISTS (
		SELECT 1 FROM dbo.GlobalCodes WHERE Category = 'XCDLEGAL' AND CodeName='Involuntary ? Criminal'
		)
BEGIN
	INSERT INTO globalcodes (
		Category
...
END
IF NOT EXISTS (
		SELECT 1 FROM dbo.GlobalCodes WHERE Category = 'XCDLEGAL' AND CodeName='Unrecorded'
		)
BEGIN
	INSERT INTO globalcodes (
		Category
...
IF NOT EXISTS(SELECT 1 
              FROM   GlobalCodes 
              WHERE  Category = 'XEDUCATIONALSTATUS' 
                     AND CodeName = 'Continuing Education') 
  BEGIN 
      INSERT INTO GlobalCodes 
                  (Category,CodeName,Active,CannotModifyNameOrDelete) 
      VALUES      ('XEDUCATIONALSTATUS','Continuing Education','Y','N') 
  END 
...
IF NOT EXISTS(SELECT 1 
  ...
  BEGIN 
      ...
      VALUES      ('XADVANCEDIRECTIVE','Yes','Y','N',1) 
  END 
...
IF NOT EXISTS(SELECT 1 
  ...
  BEGIN 
      INSERT INTO GlobalCodes 
                  (Category,CodeName,Active,CannotModifyNameOrDelete,sortorder) 
      VALUES      ('XADVANCEDIRECTIVE','No','Y','N',2) 
  END 
...
IF NOT EXISTS(SELECT 1 
  ...
  BEGIN 
      INSERT INTO GlobalCodes 
                  (Category,CodeName,Active,CannotModifyNameOrDelete,SortOrder) 
      VALUES      ('XMILITARYSERVICE','Yes','Y','N',1) 
  END   
   IF NOT EXISTS(SELECT 1 
              FROM   GlobalCodes 
              WHERE  Category = 'XMILITARYSERVICE' 
  ...
  BEGIN 
      INSERT INTO GlobalCodes 
                  (Category,CodeName,Active,CannotModifyNameOrDelete,SortOrder) 
      VALUES      ('XMILITARYSERVICE','No','Y','N',2) 
  END   
