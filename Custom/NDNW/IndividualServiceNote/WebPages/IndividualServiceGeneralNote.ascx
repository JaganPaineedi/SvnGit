<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IndividualServiceGeneralNote.ascx.cs" Inherits="Custom_IndividualServiceNote_WebPages_IndividualServiceGeneralNote" %>
<input type="hidden" id="HiddenFieldPageTables" name="HiddenFieldPageTables" value="CustomDocumentIndividualServiceNotes" />
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        onTabSelected(s,e);      
                    ...
                    <TabPages>
                        ...
                        <dxtc:TabPage Text="ClubHouse" Name="/Custom/IndividualServiceNote/WebPages/IndividualServiceNoteDBT.ascx">
                            <ContentCollection>
