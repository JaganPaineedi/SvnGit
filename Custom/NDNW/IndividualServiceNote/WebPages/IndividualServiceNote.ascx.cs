...
public partial class Custom_IndividualServiceNote_WebPages_IndividualServiceNote : SHS.BaseLayer.ActivityPages.DocumentDataActivityMultiTabPage
{
    ...
    {
        get { return "DataSetIndividualServiceNote"; }
    }

    public override string[] TablesToBeInitialized
    {
        get { return new string[] { "CustomDocumentIndividualServiceNoteGenerals,CustomDocumentDBTs,CustomIndividualServiceNoteGoals,CustomIndividualServiceNoteObjectives,CustomIndividualServiceNoteDiagnoses" }; }
    }
}
