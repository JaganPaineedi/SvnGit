/****** Object:  StoredProcedure [dbo].[csp_RDLCustomDocumentAdultDLA]    Script Date: 08/09/2014 15:04:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[csp_RDLCustomDocumentAdultDLA]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[csp_RDLCustomDocumentAdultDLA] 
GO
...
CREATE procedure   [dbo].[csp_RDLCustomDocumentAdultDLA]
(     
...
/************************************************************************/                                                
/* Stored Procedure: [csp_RDLCustomDocumentAdultDLA]		*/                                                                             
...
/* Calls:																*/                                                
/* Author: K.SOujanya												*/    
/* Aravind   Modified on 03/22/2018    What:Corrected the division of Sum 20 Ratings by correct variable 'nQuestionsAnswered'. 
                                       Why:Earlier the 'Sum 20 Ratings' was always dividing by 20.
                                       Task #804 :New Directions - Support Go Live                                                        */                                                                              
/****************************************************************************************************************************/                  
...
BEGIN
 ...
 RAISERROR ('csp_RDLCustomDocumentAdultDLA: An Error Occured While Updating ',16,1);
