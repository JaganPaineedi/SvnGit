<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HRMDla.ascx.cs" Inherits="SHS.SmartCare.ActivityPages_Client_Detail_Assessment_HRMDla" %>
...
<div style="overflow-x: hidden">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="99%">
                                ...
                                <tr>
                                    <td class="content_tab_bg">
                                        ...
                                        <div>
                                        <table style="padding-left:425px;">
                                         <tr style="height: 4px;"></tr>
                                          <tr> <td align ="left"><label for="TextBoxSum20Ratings" class="form_label">
                                          ...
                                          <tr><td align ="left"><label for="TextBoxAverageDLA" class="form_label">
                                                        Average DLA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input class="form_textboxNew30" type="text" id="TextBoxAverageDLA"
                                                name="TextBoxAverageDLA"  disabled="disabled" datatype="Numeric" maxlength="20" style="width: 28%; height: 20px;padding: 2px; border: 1px solid #a8bac3; font-size: 11px; color: #333;" /></td></tr>
                                           <tr style="height: 3px;"></tr>
                                          <tr><td><label for="TextBoxAverageDLA" class="form_label">
                                                        Estimate GAF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input class="form_textboxNew30" type="text" id="TextBoxEstimateGAF"
                                                name="TextBoxEstimateGAF"  disabled="disabled" datatype="Numeric" maxlength="20" style="width: 28%; height: 20px;padding: 2px; border: 1px solid #a8bac3; font-size: 11px; color: #333;" /></td></tr>
                                        </table>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div id="DivScaleMessage" style="display: none; background-color: white; outline: 1px;
        top: 80px; border: 3px #1C5B94 solid; height: 150px; width: 730px; z-index: 1000;
        position: absolute;">
