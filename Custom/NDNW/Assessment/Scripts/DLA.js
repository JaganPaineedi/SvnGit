...
function CreateDLAControlHtml(domObject) {
    ...
    for (var i = 0; i < Count; i++) {
        ...
        ControlHtml += "<img style='cursor: default;vertical-align: middle' class='image21' id='img21' src='";
        ControlHtml += " ../App_Themes/Includes/Images/info.png' />";
        ControlHtml += "<input type='hidden' id='hdn21' value='" + Example + "' /> ";
        ControlHtml += "</td>";
        ControlHtml += "<td>";
