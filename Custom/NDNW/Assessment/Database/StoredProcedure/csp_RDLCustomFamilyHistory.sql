...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[csp_RDLCustomFamilyHistory]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[csp_RDLCustomFamilyHistory]
GO
  
CREATE PROCEDURE  [dbo].[csp_RDLCustomFamilyHistory]                         
(                                        
  @DocumentVersionId int                
)                                         
As                                                                                                                                                        
/************************************************************/                                                                
/* Stored Procedure: csp_RDLCustomFamilyHistory           */                                                                                                                 
...
END                                                                                          
 ...
 BEGIN CATCH                                                     
   ...
   + '*****' + isnull(Convert(varchar,ERROR_PROCEDURE()),'csp_RDLCustomFamilyHistory')                       
