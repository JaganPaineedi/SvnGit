/****** Object:  StoredProcedure [dbo].[ssp_RDLClientPrescriptionSurescripts]    Script Date: 10/30/2012 10:19:07 AM ******/
IF EXISTS ( SELECT  1
            FROM    INFORMATION_SCHEMA.ROUTINES
            WHERE   SPECIFIC_SCHEMA = 'dbo'
                    AND SPECIFIC_NAME = 'ssp_RDLClientPrescriptionSurescripts' ) 
