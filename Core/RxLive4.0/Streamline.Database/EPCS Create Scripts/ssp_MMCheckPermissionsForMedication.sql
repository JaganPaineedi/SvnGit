...
-- Aug 1 2016	Malathi Shiva  EPCS: Task# 14 Added TwoFactorAuthenticationDeviceRegistrations table to retrieve the staff device registration details
-- Aug 8 2016	Malathi Shiva  EPCS: Task# 4 Added NADEANumber column into Staff table and modified corresponding dependent Stored procedures which uses Staff table
...
/*Staff Security Questions*/                       
        ...
        if ( @@error != 0 ) 
            begin                                          
                raiserror  20002  'ssp_MMCheckPermissionsForMedication: An Error Occured'                                          
                return                                         
            end                                          
