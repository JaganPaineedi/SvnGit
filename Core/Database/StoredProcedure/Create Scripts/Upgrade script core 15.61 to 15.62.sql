----- STEP 1 ----------
IF ((select DataModelVersion FROM SystemConfigurations)  < 15.61)
BEGIN
	RAISERROR('<<< Data Model Version - Need data model version 15.61 for update.Upgrade Script Failed.>>>', 16, 1)
	RETURN 
END
...
IF ((select DataModelVersion FROM SystemConfigurations)  = 15.61)
BEGIN
Update SystemConfigurations set DataModelVersion=15.62
