...
/****** Object:  UserDefinedFunction [dbo].[ssp_GetDFAMultiTabDetailPageData]    Script Date: 12/27/2017 18:04:04 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_GetDFAMultiTabDetailPageData]'))
DROP PROCEDURE [dbo].ssp_GetDFAMultiTabDetailPageData
GO
...
CREATE PROCEDURE dbo.ssp_GetDFAMultiTabDetailPageData     
@ScreenId INT                 
,@ScreenKeyId INT              
,@StaffId INT = NULL            
,@ClientId INT = NULL            
,@CustomParameters XML = NULL                  
AS  
/************************************************************************************************                              
**  File:                                                 
**  Name: ssp_GetDFAMultiTabDetailPageData                                                
**  Desc:   
**      
**  Parameters:       
**  Input        
...
--Get Primary key of the table            
 ...
 SELECT STUFF((          
 SELECT ' SELECT * FROM '+tablename+'  WHERE '+@PrimaryKey+'='+CAST(@ScreenKeyId AS VARCHAR(100))       
