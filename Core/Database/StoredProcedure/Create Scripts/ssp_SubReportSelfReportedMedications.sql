IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_SubReportSelfReportedMedications]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ssp_SubReportSelfReportedMedications]
GO
...
CREATE PROCEDURE  [dbo].[ssp_SubReportSelfReportedMedications]                            
(                                        
@DocumentVersionId  int         
)                                        
as                                        
/************************************************************************/                                                  
/* Stored Procedure: ssp_SubReportSelfReportedMedications  3315922		 */                                                                     
...
BEGIN TRY  
  ...
  WHERE CM.ClientId = @ClientId 
   ...
   AND ISNULL(MRCM.MedicationType,'') = 'S'
...
BEGIN CATCH                                                     
   ...
   + '*****' + isnull(Convert(varchar,ERROR_PROCEDURE()),'ssp_SubReportSelfReportedMedications')                       
