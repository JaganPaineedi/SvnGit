IF EXISTS ( SELECT	*
			FROM	sys.objects
			WHERE	object_id = OBJECT_ID(N'[dbo].[csp_RDLClientPrescriptionFax]')
					AND type IN ( N'P', N'PC' ) ) 
	DROP PROCEDURE [dbo].[csp_RDLClientPrescriptionFax]
GO

/****** Object:  StoredProcedure [csp_RDLClientPrescriptionFax]    Script Date: 1/2/2013 2:12:48 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [csp_RDLClientPrescriptionFax]
...
/*
   ...
   srf/ter - 09-14-2010 -- print different strengths of c2 meds on different pages
	...
	Anto - 22/Sep/2017 -  Modified the logic to display Chart copy on the RDL while faxing an order. KCMHSAS - Support #481        
