----- STEP 1 ----------
IF ((select DataModelVersion FROM SystemConfigurations)  < 16.64)
BEGIN
	RAISERROR('<<< Data Model Version - Need data model version 16.64 for update.Upgrade Script Failed.>>>', 16, 1)
	RETURN 
END
------ STEP 2 -----------
...
IF ((select DataModelVersion FROM SystemConfigurations)  = 16.64)
BEGIN
Update SystemConfigurations set DataModelVersion=16.65
