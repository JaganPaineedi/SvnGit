...
/*       */  
/* Date              Author                  Purpose                 */  
/* 10/07/2017		 Sunil.D	            SC: Implantable Devices New List page Screen  Meaning full Use  #24
*/  
/*********************************************************************/  
/**  Change History **/                                                                           
/********************************************************************************/                                                                             
...
SET @DocumentName = 'Implantable Devices List'
SET @DocumentDescription ='Implantable Devices List'
SET @DocumentType = 10
SET @Active = 'Y'
SET @ServiceNote = 'N'	
...
SET @ScreenId = 1234
SET @ScreenName = 'Implantable Devices List' 
SET @ScreenType = 5762 
SET @ScreenURL = '/Modules/ImplantableDevices/ActivityPages/Client/ListPages/ImplantableDevicesList.ascx' 
...
SET @ValidationStoredProcedureComplete= 'ssp_SCValidateImplantableDevices'
...
SET @BannerName = 'Implantable Devices List'
SET @dispalyAs = 'Implantable Devices List'
SET @BannerActive = 'Y'
SET @DefaultOrder = 1
SET @IsCustom = 'Y'
