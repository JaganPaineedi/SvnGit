...
/*       */  
/* Date              Author                  Purpose                 */  
/*10/07/2017		 Sunil.D	            SC: Implantable Devices New Details Screen  Meaning full Use  #24
*/  
/*********************************************************************/  
/**  Change History **/                                                                           
/********************************************************************************/                                                                             
...
SET @DocumentName = 'Implantable Devices'
SET @DocumentDescription ='Implantable Devices'
SET @DocumentType = 10
SET @Active = 'Y'
SET @ServiceNote = 'N'	
...
SET @StoredProcedure ='ssp_SCGetImplantableDevices'
SET @TableList ='ImplantableDevices'
...
SET @ValidationStoredProcedure = 'ssp_SCValidateImplantableDevices'
...
SET @NewValidationStoredProcedure = 'ssp_SCValidateImplantableDevices'
...
DECLARE @WarningStoreProcedureUpdate  VARCHAR(500) 


SET @ScreenId = 1232
SET @ScreenName = 'Implantable Devices' 
SET @ScreenType = 5761 
SET @ScreenURL ='/Modules/ImplantableDevices/ActivityPages/Client/Detail/ImplantableDeviceDetails.ascx'
SET @ScreenToolbarURL = NULL
SET @TabId = 2 
SET @InitializationStoredProcedure = 'ssp_SCInitializeImplantableDevices' 
SET @ValidationStoredProcedureUpdate = 'ssp_SCValidateImplantableDevices' 
...
SET @WarningStoreProcedureUpdate=null
...
ELSE 
  BEGIN 
      ...
      SET    ScreenName = @ScreenName, 
             ...
             WarningStoreProcedureUpdate=@WarningStoreProcedureUpdate,
...
SET @BannerName = 'Implantable Devices'
SET @dispalyAs = 'Implantable Devices'
SET @BannerActive = 'Y'
SET @DefaultOrder = 1
SET @IsCustom = 'N'
--SET @ParentBannerId = (SELECT top 1 BannerId FROM dbo.Banners WHERE BannerName = 'Assessments' ) 
--SET @ParentBannerId =null
--IF NOT EXISTS (SELECT 1 FROM dbo.Banners WHERE ScreenId =@ScreenId AND BannerName = 'Implantable Devices')
