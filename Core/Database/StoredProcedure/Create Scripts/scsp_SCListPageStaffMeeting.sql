IF EXISTS (SELECT * 
  ...
  DROP PROCEDURE [dbo].[scsp_SCListPageStaffMeeting] 

GO 
               
CREATE procedure [dbo].[scsp_SCListPageStaffMeeting]           
...
@OtherFilter INT                                                                     
/********************************************************************************/                
/* Stored Procedure: scsp_SCListPageStaffMeeting       */       
...
IF EXISTS ( SELECT	*
			FROM	sys.objects
			WHERE	object_id = OBJECT_ID(N'[dbo].[csp_SCListPageStaffMeeting]')
					AND type IN ( N'P', N'PC' ) ) 
BEGIN					
	
	EXEC csp_SCListPageStaffMeeting @SessionId,@InstanceId,@PageNumber,@PageSize,@SortExpression,
...
SELECT DISTINCT                     
 ...
 BEGIN CATCH                                                                                                                                                                                                                                          
   ...
   + '*****' + isnull(Convert(varchar,ERROR_PROCEDURE()),'scsp_SCListPageStaffMeeting')                                                                                            
