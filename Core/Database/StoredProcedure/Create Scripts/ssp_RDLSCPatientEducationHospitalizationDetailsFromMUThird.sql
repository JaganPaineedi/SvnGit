 IF EXISTS (
		SELECT 1
		FROM sys.objects
		WHERE object_id = OBJECT_ID(N'[dbo].[ssp_RDLSCPatientEducationHospitalizationDetailsFromMUThird]')
			AND type IN (
				N'P'
				,N'PC'
				)
		)
	DROP PROCEDURE [dbo].[ssp_RDLSCPatientEducationHospitalizationDetailsFromMUThird]
GO
...
GO
 ...
 CREATE PROCEDURE [dbo].[ssp_RDLSCPatientEducationHospitalizationDetailsFromMUThird] (                
 @StaffId INT                
 ,@StartDate DATETIME                
 ,@EndDate DATETIME                
 ,@MeasureType INT                
 ...
 /********************************************************************************                    
-- Stored Procedure: dbo.ssp_RDLSCPatientEducationHospitalizationDetailsFromMUThird                      
--                    
...
--END          
 ...
 BEGIN CATCH    
  ...
  + ISNULL(CONVERT(VARCHAR, ERROR_PROCEDURE()), 'ssp_RDLSCPatientEducationHospitalizationDetailsFromMUThird') + '*****'     
