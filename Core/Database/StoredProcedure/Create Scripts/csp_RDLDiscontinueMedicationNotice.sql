...
Ravichandra     Nov  05, 2015    what:Changed code to display Clients LastName and FirstName when ClientType='I' else  OrganizationName.  /   
							    why:task #609, Network180 Customization
Lakshmi			Dec  05, 2017   Added active check in ClientAllergies table, As per the task Bear River - Support Go Live #352
Prem            July 06, 2017   Added Discontinued Reason Code And Discontinued Reason Field as part of KCMHSAS - Enhancements: 752
Prabina         July 04, 2018   What: Merged custom sp with core sp because core sp is override custom sp and removed custom sp from kalamazoo and network180.
					            Why : Task #1089,KCMHSAS - Support  
*/
...
--	,'Summit Pointe' as OrganizationName
	...
	*/ ,
            ...
            (ISNULL(dbo.csf_GetGlobalCodeNameById(cm.DiscontinuedReasonCode)+ SPACE(5),'') + Isnull(cm.DiscontinuedReason,'')) As DiscontinuedReason,
