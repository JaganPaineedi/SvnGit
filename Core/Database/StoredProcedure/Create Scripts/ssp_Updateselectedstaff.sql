/****** Object:  StoredProcedure [dbo].[ssp_Updateselectedstaff]   ******/
IF EXISTS ( SELECT	*
			FROM	sys.objects
			WHERE	object_id = OBJECT_ID(N'[dbo].[ssp_Updateselectedstaff]')
					AND type IN ( N'P', N'PC' ) )
	DROP PROCEDURE dbo.ssp_Updateselectedstaff
GO
...
CREATE PROC [dbo].[ssp_Updateselectedstaff]     
...
/*********************************************************************/                                        
/* Stored Procedure: dbo.ssp_Updateselectedstaff					 */                                        
...
DECLARE @Error varchar(8000)                                          
   ...
   + '*****' + isnull(Convert(varchar,ERROR_PROCEDURE()),'ssp_Updateselectedstaff ')                  
