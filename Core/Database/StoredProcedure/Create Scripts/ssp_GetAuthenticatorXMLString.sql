/****** Object:  StoredProcedure [dbo].[ssp_GetAuthenticatorXMLString]    Script Date: 09/22/2017 17:30:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_GetAuthenticatorXMLString]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ssp_GetAuthenticatorXMLString]
GO
...
CREATE PROCEDURE [dbo].[ssp_GetAuthenticatorXMLString] @ClientId INT = NULL      
...
BEGIN    
 ...
 DECLARE @PLACEHOLDERXML VARCHAR(MAX) = '<authenticator>  
    <time value="##Date##"/>  
