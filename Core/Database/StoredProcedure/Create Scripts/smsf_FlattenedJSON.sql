/****** Object:  UserDefinedFunction [dbo].[smsf_FlattenedJSON]    Script Date: 11/22/2016 12:32:52 PM ******/
IF EXISTS (
		SELECT *
		FROM sys.objects
		WHERE object_id = OBJECT_ID(N'[dbo].[smsf_FlattenedJSON]')
			AND type IN (
				N'FN'
				,N'IF'
				,N'TF'
	...
	DROP FUNCTION [dbo].[smsf_FlattenedJSON]
GO
...
CREATE FUNCTION [dbo].[smsf_FlattenedJSON] (@XMLResult XML)
