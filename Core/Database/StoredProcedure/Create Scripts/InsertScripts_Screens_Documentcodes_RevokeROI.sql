...
--    
-- Purpose: Adding Screen, Banner and DocumentCodes items for New document called Revoke Release Of Information.
...
SET @DocumentName = 'Revoke Release of Information'
SET @DocumentDescription ='Revoke Release of Information'
SET @DocumentType = 10
SET @Active = 'Y'
SET @ServiceNote = 'N'	
...
SET @ViewDocumentURL ='RDLRevokeReleaseofInformation'
SET @ViewDocumentRDL ='RDLRevokeReleaseofInformation'
SET @StoredProcedure ='ssp_SCGetDocumentRevokeROI'
SET @TableList ='DocumentRevokeReleaseOfInformations'
...
SET @InitializationStoredProcedure = 'ssp_InitDocumentRevokeROI'
SET @FormCollectionId = NULL
SET @ValidationStoredProcedure = NULL
SET @ViewStoredProcedure = 'ssp_RDLDocumentRevokeROI'
...
SET @ScreenId = 1298
SET @ScreenName = 'Revoke Release of Information' 
SET @ScreenType = 5763 
SET @ScreenURL = '/Modules/RevokeROI/WebPages/RevokeROIMain.ascx'
SET @ScreenToolbarURL = NULL
SET @TabId = 2 
SET @InitializationStoredProcedure = 'ssp_InitDocumentRevokeROI' 
SET @ValidationStoredProcedureUpdate = NULL 
SET @ValidationStoredProcedureComplete=  'ssp_validateRevokeROI'
SET @WarningStoredProcedureComplete= NULL
SET @PostUpdateStoredProcedure=  'ssp_SCPostSignatureUpdateRevokeROI'
...
SET @BannerName = 'Revoke Release of Information'
SET @dispalyAs = 'Revoke Release of Information'
SET @BannerActive = 'Y'
SET @DefaultOrder = 1
SET @IsCustom = 'N'
SET @ParentBannerId = 21

IF NOT EXISTS (SELECT 1 FROM dbo.Banners WHERE ScreenId =@ScreenId AND BannerName = 'Revoke Release of Information')
...
SET @NavigationName = 'Revoke Release of Information' 
SET @DisplayAs =  'Revoke Release of Information' 
