...
/*       */  
/* Date              Author                  Purpose                 */  
/* 4/11/2015		 Sunil.D	            SC: Treatment Episode New Screen and Banner not Client Episode
...
SET @StoredProcedure ='ssp_SCGetTreatmentEpisode'
...
SET @ValidationStoredProcedure = 'ssp_SCValidateTreatmentEpisode'
...
SET @NewValidationStoredProcedure = 'ssp_SCValidateNewTreatmentEpisode'
...
SET @ScreenId = 1223
SET @ScreenName = 'Treatment Episode Details' 
SET @ScreenType = 5761 
SET @ScreenURL = '/Modules/TreatmentEpisode/ActivityPages/Client/Detail/TreatmentEpisodeDetailsMain.ascx'
SET @ScreenToolbarURL = NULL
SET @TabId = 2 
SET @InitializationStoredProcedure = 'ssp_SCInitializeTreatmentEpisode' 
SET @ValidationStoredProcedureUpdate = 'ssp_SCValidateTreatmentEpisode' 
...
--SET @BannerName = 'Treatment Episode Details'
