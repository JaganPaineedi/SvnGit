...
--    
-- Purpose: Creating Detail Page for Classroom Assignment
...
SET @ScreenId = 1320
SET @ScreenName = 'Classroom Assignment Detail' 
SET @ScreenType = 5761 
SET @ScreenURL = '/Modules/Classroom/WebPages/ClassroomAssignmentMain.ascx'
