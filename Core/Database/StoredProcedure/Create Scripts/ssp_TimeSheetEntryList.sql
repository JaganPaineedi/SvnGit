IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_TimeSheetEntryList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ssp_TimeSheetEntryList]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE dbo.ssp_TimeSheetEntryList      
@StartDate datetime      
,@EndDate datetime      
,@LeaveType INT      
...
AS   
/****************************************************
--Stored Procedure: ssp_TimeSheetEntryList 
-- Purpose: Get TimeSheet data for list page         
--          
-- Author: Rajesh S      
-- Date:   22/12/2015
--History
