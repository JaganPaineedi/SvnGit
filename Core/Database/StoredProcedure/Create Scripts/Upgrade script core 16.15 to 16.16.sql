----- STEP 1 ----------
IF ((select DataModelVersion FROM SystemConfigurations)  < 16.15)
BEGIN
	RAISERROR('<<< Data Model Version - Need data model version 16.15 for update.Upgrade Script Failed.>>>', 16, 1)
	RETURN 
END
------ STEP 2 ----------
--Part1 Begin
...
IF ((select DataModelVersion FROM SystemConfigurations)  = 16.15)
BEGIN
Update SystemConfigurations set DataModelVersion=16.16
