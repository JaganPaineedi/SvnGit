IF EXISTS ( SELECT  *
            FROM    sys.objects
            WHERE   object_id = OBJECT_ID(N'ssp_DMCommandExecute')
                    AND type IN ( N'P', N'PC' ) )
    BEGIN
        DROP PROCEDURE ssp_DMCommandExecute;
    END;
                    GO
SET ANSI_NULLS ON
GO
...
GO
CREATE PROCEDURE [dbo].[ssp_DMCommandExecute]
