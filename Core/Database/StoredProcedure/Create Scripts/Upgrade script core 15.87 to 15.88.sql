----- STEP 1 ----------
IF ((select DataModelVersion FROM SystemConfigurations)  < 15.87)
BEGIN
	RAISERROR('<<< Data Model Version - Need data model version 15.87 for update.Upgrade Script Failed.>>>', 16, 1)
	RETURN 
END
------ STEP 2 ----------
...
IF ((select DataModelVersion FROM SystemConfigurations)  = 15.87)
BEGIN
Update SystemConfigurations set DataModelVersion=15.88
