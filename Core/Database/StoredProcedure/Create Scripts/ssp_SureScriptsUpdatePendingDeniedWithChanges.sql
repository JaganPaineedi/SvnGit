/****** Object:  StoredProcedure [dbo].[ssp_SureScriptsUpdatePendingDeniedWithChanges]    Script Date: 10/30/2012 11:14:49 AM ******/
IF EXISTS ( SELECT  1
            FROM    INFORMATION_SCHEMA.ROUTINES
            WHERE   SPECIFIC_SCHEMA = 'dbo'
                    AND SPECIFIC_NAME = 'ssp_SureScriptsUpdatePendingDeniedWithChanges' ) 
    DROP PROCEDURE [dbo].[ssp_SureScriptsUpdatePendingDeniedWithChanges]
GO
...
CREATE PROCEDURE [dbo].[ssp_SureScriptsUpdatePendingDeniedWithChanges]
/*****************************************************************************************************/
/*
Stored Procedure: dbo.ssp_SureScriptsUpdatePendingDeniedWithChanges
...
Purpose:
	Update message status indicating refill approved with changes response message is ready to be created for Surescripts
