----- STEP 1 ----------
IF ((select DataModelVersion FROM SystemConfigurations)  < 15.88)
BEGIN
	RAISERROR('<<< Data Model Version - Need data model version 15.88 for update.Upgrade Script Failed.>>>', 16, 1)
	RETURN 
END
------ STEP 2 ----------
--Part1 Begin
...
IF ((select DataModelVersion FROM SystemConfigurations)  = 15.88)
BEGIN
Update SystemConfigurations set DataModelVersion=15.89
