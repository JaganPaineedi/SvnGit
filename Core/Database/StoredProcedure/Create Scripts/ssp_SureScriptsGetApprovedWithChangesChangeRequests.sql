IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_SureScriptsGetApprovedWithChangesChangeRequests]') AND type in (N'P', N'PC'))
DROP PROCEDURE ssp_SureScriptsGetApprovedWithChangesChangeRequests
GO
...
CREATE PROCEDURE [dbo].[ssp_SureScriptsGetApprovedWithChangesChangeRequests]
AS /*****************************************************************************************************/
...
--11/14/2015                PranayB                          Added Strength w.r.t MU
--09/06/2018          PranayB           Added null check on tempRESPONSE_XML 
/*****************************************************************************************************/
    BEGIN TRY
...
-- map the script output to activities
        ...
        FOR
            ...
            WHERE   cmsa.Method = 'E'
					...
					AND cms.ScriptEventType='C' ---Added in the .cs code
