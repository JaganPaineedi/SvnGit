...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_CMReAdjudicateClaimLines]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ssp_CMReAdjudicateClaimLines]
GO
...
CREATE PROCEDURE [dbo].[ssp_CMReAdjudicateClaimLines]
    @ClaimLineId INT ,
    @UserId INT,
    @UserCode VARCHAR(30) ,
    @CurrentStatus INT         
