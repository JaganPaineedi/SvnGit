if object_id('dbo.ssp_GetLocusResult') IS NOT NULL 
  DROP PROCEDURE dbo.ssp_GetLocusResult
GO

CREATE PROCEDURE dbo.ssp_GetLocusResult
(                                                                                       
...
/* 
1. File: 9. ssp_GetLocusResult.sql		
2. Name: ssp_GetLocusResult		
...
BEGIN
		...
		SELECT	@ScreenScore1= RiskOfHarmScore,
				...
				@ScreenScore3 = MedicalAddictiveScore,
				@ScreenScore4a = RecoveryEnvironmentStressScore,
				@ScreenScore4b = RecoveryEnvironmentSupportScore,
				@ScreenScore5 = TreatmentRecoveryScore,
				@ScreenScore6 = EngagementScore
...
while (@Level = -1)
		...
		UPDATE dbo.DocumentLOCUS SET LocusScore=@Level WHERE DocumentVersionId=@DocumentVersionId
