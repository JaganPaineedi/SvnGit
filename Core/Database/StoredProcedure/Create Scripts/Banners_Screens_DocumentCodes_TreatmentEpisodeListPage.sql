...
SET @ScreenType = 5762 
SET @ScreenURL = '/Modules/TreatmentEpisode/ActivityPages/Client/ListPages/TreatmentEpisodeList.ascx'
...
SET @ValidationStoredProcedureComplete= 'ssp_SCValidateTreatmentEpisode'
