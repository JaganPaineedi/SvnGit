/****** Object:  StoredProcedure [dbo].[ssp_GetAuthorXMLString]    Script Date: 09/24/2017 13:11:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ssp_GetAuthorXMLString]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ssp_GetAuthorXMLString]
GO
...
CREATE PROCEDURE [dbo].[ssp_GetAuthorXMLString] @ClientId INT = NULL              
...
BEGIN            
 ...
 DECLARE @PLACEHOLDERXML VARCHAR(MAX) = '<author>
	<time value="##Date##"/>
	<assignedAuthor>
