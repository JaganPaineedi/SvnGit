IF OBJECT_ID('dbo.ssp_SCKPIReportObjectReferenceErrors') IS NOT NULL
  DROP PROCEDURE [dbo].[ssp_SCKPIReportObjectReferenceErrors]
GO
CREATE PROCEDURE [dbo].[ssp_SCKPIReportObjectReferenceErrors] @KPIMasterId int
AS
BEGIN TRY
  /*********************************************************************/
  ...
  ---Return:Count of Error Logs of type Object Reference for a particular period           
  ...
  AND ErrorMessage LIKE '%Object reference%');
...
BEGIN CATCH
  ...
  SET @err_msg = 'ssp_SCKPIReportObjectReferenceErrors: ' + ERROR_MESSAGE();
