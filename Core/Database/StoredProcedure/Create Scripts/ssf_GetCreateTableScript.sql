...
/****** Object:  UserDefinedFunction [dbo].[ssf_GetCreateTableScript]    Script Date: 06/12/2017 15:58:25 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (SELECT *
           FROM   sys.objects
           WHERE  object_id = OBJECT_ID(N'[dbo].[ssf_GetCreateTableScript]')
                  AND type IN ( N'FN', N'IF', N'TF', N'FS', N'FT' ))
  DROP FUNCTION [dbo].[ssf_GetCreateTableScript]  
 GO 
 
/*******************************************************************/
/*EII - 533 DFA Enhancement*/
/*Function to create Table script*/
/*******************************************************************/ 
CREATE FUNCTION [dbo].[ssf_GetCreateTableScript]  
(  
...
BEGIN  
  ...
  SET @SQL = 'IF OBJECT_ID('''+@object_name+''',N''U'') IS NULL '  
