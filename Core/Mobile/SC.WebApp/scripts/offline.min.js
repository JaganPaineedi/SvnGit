...
(function () {
    ...
    RETRY_TEMPLATE = '<a href class="offline-ui-retry"></a>', createFromHTML = function (html) {
        ...
        //return el.src = "images/infored.png";
        ...
        var button, handler;
        return el = document.getElementById("fontIcon"), addClass("offline-ui-" + Offline.state);
    }, init = function () {
        return render(), Offline.on("up", function () {
            return addClass("offline-ui-up");
        }), Offline.on("down", function () {
            return removeClass("offline-ui-down");
