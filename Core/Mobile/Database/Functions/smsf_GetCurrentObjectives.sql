...
GO
CREATE FUNCTION [dbo].[smsf_GetCurrentObjectives]
(@ClientId INT
)
RETURNS VARCHAR(MAX)
AS
             ...
             BEGIN
                 ...
                 (
                     ...
                     WHERE ISNULL(n.GoalActive, 'N') = 'Y'
                          ...
                          AND ISNULL(n.RecordDeleted, 'N') = 'N' ORDER BY o.DocumentVersionId,
                                                                          O.NeedId FOR XML PATH, ROOT
                 )
                 );
             END;
         ELSE
             ...
             BEGIN
                 ...
                 (
                     ...
                     WHERE ISNULL(CDTPO.RecordDeleted, 'N') = 'N'
                           ...
                           AND CDTPG.DocumentVersionId = @LatestCarePlanDocumentVersionID FOR XML PATH, ROOT
                 )
                 );
             END;
         ELSE
                 ...
                 (
                     SELECT o.TPGoalId AS GoalId,
                            ...
                            CASE o.Status
                                ...
                                THEN 'Y'
                                ELSE 'N'
                            END AS CustomObjectiveActive
                     FROM CustomTPObjectives o
                          JOIN CustomTPGoals n ON n.TPGoalId = o.TPGoalId
                     WHERE ISNULL(n.Active, 'Y') = 'Y'
                           AND n.DocumentVersionId = @RecentDocumentVersionId
                           AND ISNULL(o.Status, 1) <> 0 
                           AND ISNULL(o.RecordDeleted, 'N') = 'N'
                           AND ISNULL(n.RecordDeleted, 'N') = 'N' FOR XML PATH, ROOT
                 )
                 );
             END;
         ELSE
                 ...
                 IF @HasCarePlan = 'Y'
                     BEGIN
                         ...
                         (
                             ...
                             WHERE CDCPS.DocumentVersionId IN(@RecentDocumentVersionId, @PreviousDocumentVersionId)
                             ...
                             ) ORDER BY CDCPO.ObjectiveNumber FOR XML PATH, ROOT
                         )
                         );
                     END;
             END;
                     ...
                     BEGIN
                         ...
                         (
                             ...
                             FROM CarePlanObjectives AS CDTPO
                                  ...
                                  LEFT JOIN GlobalCodes GC ON GC.Code = (CASE
                             ...
                             WHERE ISNULL(CDTPO.RecordDeleted, 'N') = 'N'
                                   ...
                                   AND ISNull(PC.RecordDeleted, 'N') = 'N' ORDER BY CDTPO.ObjectiveNumber FOR XML PATH, ROOT
                         )
                         );
                     END;
             END;
