...
(
    ...
    BEGIN
        ...
        VALUES
        ('INITIALIZEGOALSOBJECTIVESFORTYPE',
         NULL,
         'To identify the custom flavor to initialize Goals and Objectives',
         'Y',
         'To identify the custom flavor to initialize Goals and Objectives',
         NULL,
         'MOBILE'
...
ELSE
    BEGIN
        UPDATE SystemConfigurationKeys
          SET
              [Value] = NULL,
              [Description] = 'To identify the custom flavor to initialize Goals and Objectives',
              Comments = 'To identify the custom flavor to initialize Goals and Objectives',
              ShowKeyForViewingAndEditing = 'Y'
        WHERE [Key] = 'INITIALIZEGOALSOBJECTIVESFORTYPE';
    END;             