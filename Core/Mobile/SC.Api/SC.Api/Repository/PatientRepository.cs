...
{
    /// <summary>
    /// PatientRepository used for all the patient filling related functionalities
    /// </summary>
    public class PatientRepository : IPatientRepository
    {
        ...
        /// <summary>
        /// Constructor of PatientRepository
        /// </summary>
        /// <param name="ctx"></param>
        public PatientRepository(SCMobile ctx)
        {
            _ctx = ctx;
            _Appointmentrepo = new AppointmentRepository(ctx);
            _DocumentRepo = new DocumentRepository(ctx);
        }
        ...
        public string GetClientId(string SSN, string FirstName, string LastName, DateTime? DOB)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetClientId method." + ex.Message);
                throw excep;
            }
        }
        ...
        public PatientDetailsModel GetPatientInformation(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetPatientInformation method." + ex.Message);
                throw excep;
            }
        }
        ...
        public string GetSummaryOfCareCCDXML(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetSummaryOfCareCCDXML method." + ex.Message);
                throw excep;
            }
            finally
        ...
        public List<PatientDemographicDetailsModel> GetDemographicDetails(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            try
            {
                ...
                //_patient.ForEach(a => {if (a.Contact != null) a.Contact.ForEach(b => b.Relationship = GetCodeableConcept(Id, "Relationship", Type, fromDate, toDate));});
                //_patient.ForEach(a => { if (a.Contact != null) a.Contact.ForEach(b => { if (b.Relationship != null) b.Relationship.ForEach(c => c.Coding = GetCoding(Id, "Relationship", Type, fromDate, toDate)); }); });
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetDemographicDetails method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<AllergiesModel> GetAllergies(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetAllergies method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<CurrentMedicationsModel> GetCurrentMedications(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            try
            {
                ...
                if (_medicationsIngredient != null)
                {
                    i = 0;
                ...
                if (_medicationsPackageContent != null)
                {
                    i = 0;
                ...
                if (_medicationsPackageBatch != null)
                {
                    i = 0;
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetCurrentMedications method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<ActiveProblemsModel> GetActiveProblems(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetActiveProblems method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<MostRecentEncountersModel> GetMostRecentEncounters(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetMostRecentEncounters method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<ImmunizationsModel> GetImmunizations(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetImmunizations method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<SocialHistoryModel> GetSocialHistory(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                var OutputParamter = new ObjectParameter("JsonResult", typeof(string));
                _ctx.ssp_GetSocialHistoryMU3(Id, Type, null, fromDate, toDate, OutputParamter);
                var json = Convert.ToString(OutputParamter.Value);
                if (json == "" || json == null) return null;
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetSocialHistory method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<VitalSignsModel> GetVitalSigns(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetVitalSigns method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<PlanOfTreatmentModel> GetPlanOfTreatment(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetPlanOfTreatment method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<GoalsModel> GetGoals(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetGoals method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<HistoryOfProceduresModel> GetHistoryOfProcedures(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetHistoryOfProcedures method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<StudiesSummaryModel> GetStudiesSummary(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetStudiesSummary method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<LaboratoryTestsModel> GetLaboratoryTests(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetLaboratoryTests method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<CareTeamMembersModel> GetCareTeamMembers(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetCareTeamMembers method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<UDIModel> GetUDI(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetUDI method." + ex.Message);
                throw excep;
            }
        }

        /// <summary>
        /// Get Health Concerns based on Identifiers
        /// </summary>
        /// <param name="Id"></param>
        /// <returns></returns>
        public List<HealthConcernsModel> GetHealthConcerns(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            try
            {
                var OutputParamter = new ObjectParameter("JsonResult", typeof(string));
                _ctx.ssp_GetHealthConcerns(Id, Type, null, fromDate, toDate, OutputParamter);
                var json = Convert.ToString(OutputParamter.Value);
                if (json == "" || json == null) return null;

                List<HealthConcernsModel> _healthConcerns = new List<HealthConcernsModel>();

                _healthConcerns = JsonConvert.DeserializeObject<List<HealthConcernsModel>>(json).ToList();

                return _healthConcerns;
            }
            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetHealthConcerns method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<IdentifierModel> GetIdentifier(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetIdentifier method." + ex.Message);
                throw excep;
            }
        }
        public List<HumanNameModel> GetHumanName(int Id, string Text, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetHumanName method." + ex.Message);
                throw excep;
            }
        }
        public List<AddressModel> GetAddress(int Id, string Text, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetAddress method." + ex.Message);
                throw excep;
            }
        }
        public List<ContactPointModel> GetTelecom(int Id, string Text, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetTelecom method." + ex.Message);
                throw excep;
            }
        }
        public List<ContactPersonModel> GetPatientContactPerson(int Id, string Type, DateTime fromDate, DateTime toDate)
        {
            try
            {
                ...
                _contactPerson.ForEach(a => a.Relationship = GetCodeableConcept(Id, "Relationship", Type, fromDate, toDate));
                _contactPerson.ForEach(a => a.Relationship.ForEach(b => b.Coding = GetCoding(Id, "Relationship", Type, fromDate, toDate)));
                _coding = GetCoding(Id, "Relationship", Type, fromDate, toDate);
                i = 0;
                if (_coding != null)
                {
                    foreach (var _code in _coding)
                    {
                        _contactPerson[i].Relationship[0].Coding.Clear();
                        _contactPerson[i].Relationship[0].Coding.Add(_code);
                        i = i + 1;
                    }
                }
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetPatientContactPerson method." + ex.Message);
                throw excep;
            }
        }
        public List<CodeableConceptModel> GetCodeableConcept(int Id, string Text, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetCodeableConcept method." + ex.Message);
                throw excep;
            }
        }
        ...
        public List<QuantityModel> GetQuantity(int Id, string Text, string Type, DateTime fromDate, DateTime toDate)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetQuantity method." + ex.Message);
                throw excep;
            }
        }

        /// <summary>
        /// Returns Primary Clinician Detail
        /// </summary>
        /// <param name="clientId"></param>
        /// <returns></returns>
        public ClinicianModel GetPrimaryClinician(int clientId)
        {
            return _ctx.Clients
                .Where(c => c.ClientId == clientId && c.RecordDeleted != "Y" && c.Staff.RecordDeleted != "Y" && c.PrimaryClinicianId != null)
                .Select(c => new ClinicianModel() { ClinicianId = c.Staff.StaffId, ClinicianName = c.Staff.DisplayAs }).FirstOrDefault();
        }

        /// <summary>
        /// Returns Program Clinicians Based on ClientId
        /// </summary>
        /// <param name="clientId"></param>
        /// <returns></returns>
        public List<ClinicianModel> GetProgramClinicians(int clientId)
        {
            try
            {
                var OutputParamter = new ObjectParameter("JsonResult", typeof(string));
                _ctx.Smsp_GetProgramClinicians(clientId, OutputParamter);
                var json = Convert.ToString(OutputParamter.Value);
                if (json == "" || json == null) return null;

                return JsonConvert.DeserializeObject<List<ClinicianModel>>(json).ToList();
            }
            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetProgramClinicians method." + ex.Message);
                throw excep;
            }
        }
        ...
        /// <returns></returns>
        public List<AppointmentResponseModel> GetAvailableAppointmentsSlots(AppointmentRequestModel request)
        {
            try
            {
                ...
                var OutputParamter = new ObjectParameter("JsonResult", typeof(string));
                _ctx.smsp_PMAppointmentSearch(sessionId, request.Id, request.ClinicianId, request.Minutes, DateTime.Parse(request.StartTime).TimeOfDay, DateTime.Parse(request.EndTime).TimeOfDay, Convert.ToDateTime(request.StartDate), OutputParamter);

                var json = Convert.ToString(OutputParamter.Value);
                if (json == "" || json == null) return null;

                return JsonConvert.DeserializeObject<List<AppointmentResponseModel>>(json).ToList();
            }
            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetAvailableAppointmentsSlots method." + ex.Message);
                throw excep;
            }
        }
        ...
        /// <param name="clientId"></param>
        /// <returns></returns>
        public Client GetClientBalance(int id)
        {
            try
            {
                return _ctx.Clients
                 .Where(c => c.ClientId == id && c.RecordDeleted != "Y").FirstOrDefault();
            }
            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetClientBalance method." + ex.Message);
                throw excep;
            }
        }
        ...
        public int UpdatePayment(ClientPaymentModel cp)
        {
            ...
            {
                Exception excep = new Exception("Exception occured in PatientRepository.UpdatePayment method." + ex.Message);
                throw excep;
            }
        }
        ...
        /// <returns></returns>
        public List<int> GetAppointmentIds(AppointmentSearchModel searchModel)
        {
            return (from app in _ctx.Appointments
                    join ser in _ctx.Services on app.ServiceId equals ser.ServiceId
                    where ser.ClientId == searchModel.Id && app.Status != 8042 && app.Status != 8045 && ser.RecordDeleted != "Y" && app.RecordDeleted != "Y" && (ser.ClinicianId == searchModel.ClinicianId || searchModel.ClinicianId == null)
                    select app.AppointmentId).ToList();
        }
        ...
        {
            return _Appointmentrepo.GetAppointment(AppointmentId);
        }
        ...
        /// <returns></returns>
        public Task<_SCResult<Models.AppointmentModel>> ScheduleAppointment(AppointmentModel appointment, int loggedInUser)
        {
            return _Appointmentrepo.Save(appointment, loggedInUser);
        }

        public ClientDocumentsModel GetDocument(int DocumentVersionId)
        {
            return _DocumentRepo.GetDocumentModel(DocumentVersionId);
        }
        /// <summary>
        /// List Patient Documents
        /// </summary>
        public List<DocumentListResponseModel> GetDocumentList(DocumentListRequestModel docRequest)
        {

            try
            {
                var staffId = _ctx.Staffs
                              .Where(s => s.TempClientId == docRequest.id && s.Active == "Y" && s.RecordDeleted != "Y")
                              .Select(s => s.StaffId).FirstOrDefault();
                var OutputParamter = new ObjectParameter("JsonResult", typeof(string));
                _ctx.smsp_GetPatientDocuments(docRequest.id, Convert.ToInt32(staffId), docRequest.AuthorId, docRequest.Status, docRequest.DueInXDays, Convert.ToInt32(staffId), docRequest.FromDate, docRequest.ToDate, docRequest.IncludeErrorDocument,0, OutputParamter);
                var json = Convert.ToString(OutputParamter.Value);
                if (json == "" || json == null) return null;
                return JsonConvert.DeserializeObject<List<DocumentListResponseModel>>(json).ToList();
            }
            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetDocumentList method." + ex.Message);
                throw excep;
            }
        }

        public bool IsNonStaffUser(int ClientId)
        {
            return _ctx.Staffs.Any(s => s.TempClientId == ClientId && s.Active == "Y" && s.RecordDeleted != "Y");

        }


        ServiceDropdownConfigurationsResponseModel IPatientRepository.GetServiceDropdownData(ServiceDropdownConfigurationsRequestModel serRequest)
        {
            ServiceDropdownConfigurationsResponseModel _serviceDropdownValues = new ServiceDropdownConfigurationsResponseModel();

            _ctx.Database.Initialize(force: false);

            var cmd = _ctx.Database.Connection.CreateCommand();
            cmd.CommandText = "[dbo].[smsp_SCGetAllDataForService]";
            cmd.CommandType = System.Data.CommandType.StoredProcedure;

            try
            {
                _ctx.Database.Connection.Open();
                cmd.Parameters.Add(new SqlParameter("ClientId", serRequest.id));
                cmd.Parameters.Add(new SqlParameter("DateOfService", serRequest.DateOfService));
                cmd.Parameters.Add(new SqlParameter("ProgramId", serRequest.ProgramId));
                cmd.Parameters.Add(new SqlParameter("AttendingId", serRequest.AttendingId));
                cmd.Parameters.Add(new SqlParameter("ProcedureCodeId", serRequest.ProcedureCodeId));
                cmd.Parameters.Add(new SqlParameter("LocationId", serRequest.LocationId));
                cmd.Parameters.Add(new SqlParameter("PlaceOfServiceId", 0));
                cmd.Parameters.Add(new SqlParameter("ClinicianId", serRequest.ClinicianId));

                var reader = cmd.ExecuteReader();

                _serviceDropdownValues.LocationDetails = ((IObjectContextAdapter)_ctx)
                       .ObjectContext
                       .Translate<LocationModel>(reader).ToList();

                reader.NextResult();

                _serviceDropdownValues.ProcedureDetails = ((IObjectContextAdapter)_ctx)
                        .ObjectContext
                        .Translate<ProcedureCodeModel>(reader).ToList();

                reader.NextResult();

                _serviceDropdownValues.ProgramDetails = ((IObjectContextAdapter)_ctx)
                    .ObjectContext
                    .Translate<ProgramModel>(reader).ToList();

                reader.NextResult();

                _serviceDropdownValues.AttendingDetails = ((IObjectContextAdapter)_ctx)
                    .ObjectContext
                    .Translate<AttendingModel>(reader).ToList();

                reader.NextResult();

                _serviceDropdownValues.PlaceOfServiceDetails = ((IObjectContextAdapter)_ctx)
                    .ObjectContext
                    .Translate<PlaceOfServiceModel>(reader).ToList();

                _serviceDropdownValues.DateOfService = serRequest.DateOfService;

                CurrentLoggedInStaff cm = new CurrentLoggedInStaff();
                cm = (CurrentLoggedInStaff)HttpContext.Current.Session["CurrentStaff"];
                ClinicianModel cmodel = _ctx.Staffs
                    .Where(s => s.StaffId == cm.StaffId)
                    .Select(s => new ClinicianModel() { ClinicianId = s.StaffId, ClinicianName = s.LastName + ", " + s.FirstName }).FirstOrDefault();

                _serviceDropdownValues.ClinicianDetails = new List<ClinicianModel>() { cmodel };
            }

            catch (Exception ex)
            {
                Exception excep = new Exception("Exception occured in PatientRepository.GetServiceDropdownData method." + ex.Message);
                throw excep;
            }
            finally
            { _ctx.Database.Connection.Close(); }
        ...
        /// <returns>returns new created Service,Appointment,Document,DocumnetVersion details</returns>
        public AppointmentModel CreateService(APIServiceModel serModel)
        {
            int result = Save(serModel);
            if (result > 0)
            {
                try
                {
                    var bRepo = new BriefcaseRepositiry(new SCMobile());
                    return bRepo.GetAppointment(Convert.ToInt32(result));
                }
                catch (Exception ex)
                {
                    Exception excep = new Exception("Exception occured in PatientRepository.CreateService method." + ex.Message);
                    throw excep;
                }
            }
            else
        ...
        /// <summary>
        /// save data in Services, Appointments, Documents and DocumentVersions
        /// </summary>
        /// <param name="serModel"></param>
        /// <returns>appointment ID</returns>
        public int Save(APIServiceModel serModel)
        {
            var ser = new Data.Service();
            var app = new Data.Appointment();
            var doc = new Data.Document();
            var docVersions = new Data.DocumentVersion();
            if (serModel != null)
            {
                String clientName = _ctx.Clients
                                  .Where(c => c.ClientId == serModel.Id)
                                  .Select(s => s.LastName + ", " + s.FirstName).FirstOrDefault();
                var pCode = _ctx.ProcedureCodes
                                   .Where(p => p.ProcedureCodeId == serModel.ProcedureCodeId)
                                   .Select(p => new
                                   {
                                       DisplayAs = p.DisplayAs,
                                       AssociatedNoteId = p.AssociatedNoteId,
                ...
                {
                    var cmd = _ctx.Database.Connection.CreateCommand();
                    cmd.CommandText = "[dbo].[ssp_PMServiceCalculateCharge]";
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    try
                    {
                        cmd.Parameters.Add(new SqlParameter("@ClientId", serModel.Id));
                        cmd.Parameters.Add(new SqlParameter("@DateOfService", serModel.DateOfService));
                        cmd.Parameters.Add(new SqlParameter("@ClinicianId", serModel.ClinicianId));
                        cmd.Parameters.Add(new SqlParameter("@ProcedureCodeId", serModel.ProcedureCodeId));
                        cmd.Parameters.Add(new SqlParameter("@Units", serModel.Unit));
                        cmd.Parameters.Add(new SqlParameter("@ProgramId", serModel.ProgramId));
                        cmd.Parameters.Add(new SqlParameter("@LocationId", serModel.LocationId));
                        var procRate = new SqlParameter("@ProcedureRateId", SqlDbType.Int) { Direction = ParameterDirection.Output };
                        cmd.Parameters.Add(procRate);
                        var charge = new SqlParameter("@Charge", SqlDbType.Money) { Direction = ParameterDirection.Output };
                        cmd.Parameters.Add(charge);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Transaction = dbTransaction.UnderlyingTransaction;
                        var reader = cmd.ExecuteReader();
                        reader.Close();

                        #region Services
                        ser.ServiceId = -1;
                        ser.CreatedBy = cm.UserCode;
                        ser.CreatedDate = DateTime.Now;
                        ser.ModifiedBy = cm.UserCode;
                        ser.ModifiedDate = DateTime.Now;
                        ser.ClientId = serModel.Id;
                        ser.ProcedureCodeId = serModel.ProcedureCodeId;
                        ser.DateOfService = serModel.DateOfService;
                        ser.Unit = serModel.Unit;
                        ser.UnitType = pCode.EnteredAs;
                        ser.Status = 71;
                        ser.ClinicianId = serModel.ClinicianId;
                        ser.AttendingId = serModel.AttendingId != 0 ? serModel.AttendingId :(int ?)null;
                        ser.ProgramId = serModel.ProgramId;
                        ser.LocationId = serModel.LocationId;
                        ser.Billable = "N";
                        ser.ClientWasPresent = "Y";
                        ser.AuthorizationsApproved = 0;
                        ser.AuthorizationsNeeded = 0;
                        ser.AuthorizationsRequested = 0;
                        ser.Charge = (charge.Value == null || charge.Value is DBNull ) ? (decimal?)null : Convert.ToDecimal(charge.Value) ;
                        ser.ProcedureRateId = (procRate.Value == null || procRate.Value is DBNull) ? (int?)null : Convert.ToInt32(procRate.Value);
                        ser.Comment = null;
                        ser.SpecificLocation = serModel.SpecificLocation;
                        ser.NoteReplacement = "N";

                        if (pCode.EnteredAs == 110)
                        {
                            ser.EndDateOfService = app.EndTime = serModel.DateOfService.AddMinutes(Convert.ToDouble(serModel.Unit));
                        }
                        else if (pCode.EnteredAs == 111)
                        {
                            ser.EndDateOfService = app.EndTime = serModel.DateOfService.AddHours(Convert.ToDouble(serModel.Unit));
                        }
                        else if (pCode.EnteredAs == 112)
                        {
                            ser.EndDateOfService = app.EndTime = serModel.DateOfService.AddDays(Convert.ToDouble(serModel.Unit));
                        }
                        else
                        {
                            ser.EndDateOfService = app.EndTime = serModel.DateOfService;
                        }

                        if (pCode.RequiresTimeInTimeOut == "Y")
                        {
                            ser.DateTimeIn = serModel.DateOfService;
                            ser.DateTimeOut = ser.EndDateOfService;
                        }
                        #endregion
                        #region Appointments
                        app.AppointmentId = -1;
                        app.CreatedBy = cm.UserCode;
                        app.CreatedDate = DateTime.Now;
                        app.ModifiedBy = cm.UserCode;
                        app.ModifiedDate = DateTime.Now;
                        app.StaffId = serModel.ClinicianId;
                        app.Subject = "Client: " + clientName + " (#" + serModel.Id + ") " + pCode.DisplayAs;
                        app.StartTime = serModel.DateOfService;
                        app.AppointmentType = 4761;
                        app.ShowTimeAs = 4342;
                        app.ClientId = serModel.Id;
                        app.LocationId = serModel.LocationId;
                        app.ServiceId = ser.ServiceId;
                        #endregion
                        #region Documents
                        doc.DocumentId = -1;
                        doc.CreatedBy = cm.UserCode;
                        doc.CreatedDate = DateTime.Now;
                        doc.ModifiedBy = cm.UserCode;
                        doc.ModifiedDate = DateTime.Now;
                        doc.ClientId = serModel.Id;
                        doc.ServiceId = ser.ServiceId;
                        doc.DocumentCodeId = pCode.AssociatedNoteId;
                        doc.EffectiveDate = serModel.EffectiveDate;
                        doc.Status = 21;
                        doc.AuthorId = serModel.ClinicianId;
                        doc.DocumentShared = "Y";
                        doc.SignedByAuthor = "N";
                        doc.SignedByAll = "N";
                        doc.CurrentVersionStatus = 21;
                        #endregion
                        #region DocumentVersions
                        docVersions.DocumentVersionId = -1;
                        docVersions.CreatedBy = cm.UserCode;
                        docVersions.CreatedDate = DateTime.Now;
                        docVersions.ModifiedBy = cm.UserCode;
                        docVersions.ModifiedDate = DateTime.Now;
                        docVersions.DocumentId = doc.DocumentId;
                        docVersions.Version = 1;
                        docVersions.AuthorId = serModel.ClinicianId;
                        docVersions.EffectiveDate = serModel.EffectiveDate;
                        docVersions.RevisionNumber = 1;
                        #endregion

                        _ctx.Services.Add(ser);
                        _ctx.Appointments.Add(app);
                        _ctx.Documents.Add(doc);
                        _ctx.DocumentVersions.Add(docVersions);
                        _ctx.SaveChanges();
                        var currentDocument = _ctx.Documents.FirstOrDefault(a => a.DocumentId == docVersions.DocumentId);
                        currentDocument.InProgressDocumentVersionId = docVersions.DocumentVersionId;
                        currentDocument.CurrentDocumentVersionId = docVersions.DocumentVersionId;
                        _ctx.SaveChanges();
                    ...
                    catch (Exception ex)
                    {
                        ...
                        Exception excep = new Exception("Exception occured in PatientRepository.Save method." + ex.Message);
                        throw excep;
                    }
                }
